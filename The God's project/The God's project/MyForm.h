...
namespace project {
	...
	fstream path1("C:\\test.txt", ios::in);
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label11->Text = L"Статус файла.";
			// 
			// label12
			// 
			...
			this->label13->Text = L"Проверка данных";
			// 
			// panel1
			// 
			...
			this->label14->Text = L"Кол-во строк : ";
			// 
			// tabControl1
			// 
			...
			this->tabPage3->Text = L"Плотность";
...
#pragma endregion
	...
	private: System::Void MyForm_Load(System::Object^  sender, System::EventArgs^  e) {
		...
		label11->Text = "Пока ничего не открыто";
		label12->Text = "Данные из файла!";
		label13->Text = "";
		label14->Text = "Кол-во строк : ";
		label15->Text = "Неизвестно";
		label16->Text = "Список x арг.";
		label17->Text = "Список y арг.";
	...
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (!path)
		{
			...
			label11->Text = "Статус: Не открыт!!";
			MessageBox::Show("Путь к файлу не совпадает!!\nФайл должна быть в диске C\nа название файла test.txt",
				"Ошибка, вопрос жизни и смерти", MessageBoxButtons::OKCancel,
		...
		else
		{
			...
			label11->Text = "Статус Файла: Открыт!!";
		...
		if (!path1)
		{
			...
			label14->ForeColor = Color::FromArgb(150, Color::Red);
			label15->Text = "Невозможно вычислить!";
		}
		else
		{
